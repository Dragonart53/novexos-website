  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <h3 className={`font-display text-2xl font-bold mb-4 text-${feature.color} group-hover:neon-text transition-all duration-300`}>
          {feature.title}
        </h3>
...
export default function Features() {
  ...
  return (
    <section className="relative py-32 px-6 bg-cyber-black grid-bg">
